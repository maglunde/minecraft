...
public enum BlockType {
    ...
    BIRCH_LOG((byte) 108, true, false, 132, 132, 131),
    BIRCH_LEAVES((byte) 109, true, true, 133, 133, 133),
    ACACIA_LOG((byte) 110, true, false, 135, 135, 134),
    ACACIA_LEAVES((byte) 111, true, true, 136, 136, 136),
    DARK_OAK_LOG((byte) 112, true, false, 138, 138, 137),
    DARK_OAK_LEAVES((byte) 113, true, true, 139, 139, 139),
    RED_SAND((byte) 114, true, false, 140, 140, 140),
    TERRACOTTA((byte) 115, true, false, 141, 141, 141),
    RED_TERRACOTTA((byte) 116, true, false, 142, 142, 142),
    ORANGE_TERRACOTTA((byte) 117, true, false, 143, 143, 143),
    YELLOW_TERRACOTTA((byte) 118, true, false, 144, 144, 144),
    WHITE_TERRACOTTA((byte) 119, true, false, 145, 145, 145),
    BROWN_TERRACOTTA((byte) 120, true, false, 146, 146, 146);
    ...
    public float getHardness() {
        return 3 *  switch (this) {
            ...
            case END_STONE -> 3.0f;
            case STONE -> 1.5f;
            case BASALT, TERRACOTTA, RED_TERRACOTTA, ORANGE_TERRACOTTA, YELLOW_TERRACOTTA, WHITE_TERRACOTTA, BROWN_TERRACOTTA -> 1.25f;
            case COAL_ORE, IRON_ORE, GOLD_ORE, DIAMOND_ORE, NETHER_QUARTZ_ORE -> 3.0f;
            case COBBLESTONE, BRICKS, WOOD, PLANKS, FENCE, FENCE_GATE, WOODEN_SLAB, WOODEN_STAIRS, NETHER_BRICKS, BIRCH_LOG, ACACIA_LOG, DARK_OAK_LOG -> 2.0f;
            case FURNACE -> 3.5f;
            case SPAWNER -> 5.0f;
            case SANDSTONE -> 0.8f;
            case GRAVEL -> 0.6f;
            ...
            case LADDER -> 0.4f;
            case DIRT, RED_SAND -> 0.5f;
            case GRASS -> 0.6f;
            case SAND -> 0.5f;
            case CACTUS -> 0.4f;
            case GLASS, LEAVES, SNOW_BLOCK, BIRCH_LEAVES, ACACIA_LEAVES, DARK_OAK_LEAVES -> 0.2f;
            case WOOL -> 0.8f;
            case TORCH -> 0.0f;
            default -> 0.0f;
        };
    ...
    public ToolType getEffectiveTool() {
        return switch (this) {
            case STONE, COBBLESTONE, BRICKS, FURNACE, OBSIDIAN, NETHERRACK, NETHER_BRICKS, END_STONE, NETHER_QUARTZ_ORE, BASALT, SPAWNER, SANDSTONE, COAL_ORE, IRON_ORE, GOLD_ORE, DIAMOND_ORE, TERRACOTTA, RED_TERRACOTTA, ORANGE_TERRACOTTA, YELLOW_TERRACOTTA, WHITE_TERRACOTTA, BROWN_TERRACOTTA -> ToolType.PICKAXE;
            case WOOD, PLANKS, CHEST, CRAFTING_TABLE, WOODEN_DOOR, TRAPDOOR, FENCE, FENCE_GATE, WOODEN_STAIRS, WOODEN_SLAB, CACTUS, BIRCH_LOG, ACACIA_LOG, DARK_OAK_LOG -> ToolType.AXE;
            case DIRT, GRASS, SAND, RED_SAND, SOUL_SAND, GRAVEL, SNOW_BLOCK -> ToolType.SHOVEL;
            case LEAVES, BIRCH_LEAVES, ACACIA_LEAVES, DARK_OAK_LEAVES -> ToolType.SWORD;
    ...
    public boolean requiresToolForDrop() {
        return switch (this) {
            case STONE, COBBLESTONE, BRICKS, FURNACE, OBSIDIAN, NETHERRACK, NETHER_BRICKS, END_STONE, NETHER_QUARTZ_ORE, BASALT, SANDSTONE, COAL_ORE, IRON_ORE, GOLD_ORE, DIAMOND_ORE, TERRACOTTA, RED_TERRACOTTA, ORANGE_TERRACOTTA, YELLOW_TERRACOTTA, WHITE_TERRACOTTA, BROWN_TERRACOTTA -> true;
            default -> false;
        };
    }
    ...
    public String getDigSound() {
        return switch (this) {
            case STONE, COBBLESTONE, BRICKS, BEDROCK, FURNACE, OBSIDIAN, NETHERRACK, NETHER_BRICKS, END_STONE, DRAGON_EGG, END_PORTAL_FRAME, END_PORTAL_FRAME_FILLED, NETHER_QUARTZ_ORE, BASALT, SANDSTONE, COAL_ORE, IRON_ORE, GOLD_ORE, DIAMOND_ORE, TERRACOTTA, RED_TERRACOTTA, ORANGE_TERRACOTTA, YELLOW_TERRACOTTA, WHITE_TERRACOTTA, BROWN_TERRACOTTA -> "dig_stone";
            case WOOD, PLANKS, CRAFTING_TABLE, CHEST, TRAPDOOR, FENCE, FENCE_GATE, WOODEN_SLAB, WOODEN_STAIRS, CACTUS, TORCH, BIRCH_LOG, ACACIA_LOG, DARK_OAK_LOG -> "dig_wood";
            case SAND, RED_SAND, SOUL_SAND, GRAVEL -> "dig_sand";
            case DIRT, GRASS, LEAVES, SNOW_BLOCK, WOOL, BIRCH_LEAVES, ACACIA_LEAVES, DARK_OAK_LEAVES -> "dig_grass";
    ...
    public String getBreakSound() {
        return switch (this) {
            case STONE, COBBLESTONE, BRICKS, BEDROCK, FURNACE, OBSIDIAN, NETHERRACK, NETHER_BRICKS, END_STONE, DRAGON_EGG, END_PORTAL_FRAME, END_PORTAL_FRAME_FILLED, NETHER_QUARTZ_ORE, BASALT, SANDSTONE, COAL_ORE, IRON_ORE, GOLD_ORE, DIAMOND_ORE, TERRACOTTA, RED_TERRACOTTA, ORANGE_TERRACOTTA, YELLOW_TERRACOTTA, WHITE_TERRACOTTA, BROWN_TERRACOTTA -> "break_stone";
            case WOOD, PLANKS, CRAFTING_TABLE, CHEST, TRAPDOOR, FENCE, FENCE_GATE, WOODEN_SLAB, WOODEN_STAIRS, CACTUS, TORCH, BIRCH_LOG, ACACIA_LOG, DARK_OAK_LOG -> "break_wood";
            case DIRT, GRASS, LEAVES, SAND, RED_SAND, SOUL_SAND, GRAVEL, SNOW_BLOCK, WOOL, BIRCH_LEAVES, ACACIA_LEAVES, DARK_OAK_LEAVES -> "break_grass";
