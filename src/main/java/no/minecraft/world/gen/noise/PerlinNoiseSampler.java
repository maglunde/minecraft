...
/**
 * Ken Perlin Improved Noise (2002) tilpasset Minecraft Java Edition.
 * Bruker permutasjonstabell og quintic fade-kurve for glatt, deterministisk støy.
 */
public class PerlinNoiseSampler {
    private final int[] p = new int[512];

    public PerlinNoiseSampler(long seed) {
